# Omni-IDE v2.0.0: Project Overview

## High-Level Architecture
Omni-IDE v2.0.0 represents a complete paradigm shift from its legacy predecessors. Originally built on a hybrid FastAPI & PyWebView foundation, the core has been entirely re-engineered using **TypeScript** and **Node.js**, leveraging the production-ready **VS Code core** architecture.
...
The defining feature of v2.0 is the **Omni-Agent**. This is a local-native agentic AI integration that goes beyond simple chat interfaces.
